    ...
    function saveProduct() {
        if ($('#frmMaintainance').valid()) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    std.notify('Update product successful', 'success');
                ...
                error: function () {
                    std.notify('Has an error in save product progress', 'error');
                    std.stopLoading();
                }
            });
            return false;
    ...
    function deleteProduct(id) {
        std.confirm('Are you sure to delete?', function () {
            $.ajax({
                ...
                success: function (response) {
                    std.notify('Delete successful', 'success');
                    std.stopLoading();
                    loadData();
                },
                error: function (status) {
                    std.notify('Has an error in delete progress', 'error');
                    std.stopLoading();
                }
            });
        });
