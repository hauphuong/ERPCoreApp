    ...
    function registerEvents() {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        std.notify('Update role successful', 'success');
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    std.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    std.stopLoading();
                },
                error: function () {
                    std.notify('Has an error in save permission progress', 'error');
                    std.stopLoading();
                }
            });
        });
