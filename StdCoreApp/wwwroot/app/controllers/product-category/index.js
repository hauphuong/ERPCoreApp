        ...
        $("#fileInputImage").on('change', function () {
            ...
            $.ajax({
                ...
                success: function (path) {
                    $('#txtImage').val(path);
                    std.notify('Upload image succesful!', 'success');

                },
                error: function () {
                    std.notify('There was error uploading files!', 'error');
                }
            });
        });
        ...
        $('body').on('click', '#btnDelete', function (e) {
            ...
            std.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function (response) {
                        std.notify('Deleted success', 'success');
                        std.stopLoading();
                        loadData();
                    },
                    error: function (status) {
                        std.notify('Has an error in deleting progress', 'error');
                        std.stopLoading();
                    }
                });
            });
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        std.notify('Update success', 'success');
                    ...
                    error: function () {
                        std.notify('Has an error in update progress', 'error');
                        std.stopLoading();
                    }
                });
            }
    ...
    function loadData() {
        $.ajax({
            ...
            success: function (response) {
                ...
                var treeArr = std.unflattern(data);
